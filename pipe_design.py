...
def main(s3, S3_BUCKET, s3_keys_csv, folder_name, design_names):
    ...
    s3_key_xlsx_unf = ''.join(['design', '/', folder_name, '/', 'unformatted xlsx', '/', 'unformatted.xlsx'])
    ...
    s3_key_xlsx_form = ''.join(['design', '/', folder_name, '/', 'formatted xlsx', '/', 'formatted.xlsx'])
